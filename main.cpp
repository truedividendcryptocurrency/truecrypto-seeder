...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "truecrypto-seeder\n"
...
static const string mainnet_seeds[] = {
                                        "seeder.truedividendcrypto.org",
                                        "node1.truedividendcrypto.org",
                                        "node2.truedividendcrypto.org",
                                        "node3.truedividendcrypto.org",
                                        "node4.truedividendcrypto.org",
                                        "node5.truedividendcrypto.org",
                                        "node6.truedividendcrypto.org",
                                        "node7.truedividendcrypto.org",
                                        "node8.truedividendcrypto.org",
                                        "node9.truedividendcrypto.org", "node10.truedividendcrypto.org", ""};
static const string testnet_seeds[] = {"seeder.truedividendcrypto.org", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjz2eqxk4zwi5zd3.onion", 17281), true); //TODO: clarify this .onion
  }
  do {
